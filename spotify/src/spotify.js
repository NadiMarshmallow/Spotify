...
import { Collapse, Button, Table, Media, } from 'reactstrap';
...
export default class Spotify extends Component {
  constructor(props) {
    ...
    this.state = { collapseTracks: false, collapseArtists: false
    };
   
  }

  toggleTracks() {
    this.setState({ collapseTracks: !this.state.collapseTracks });
  }

  toggleArtists() {
    this.setState({ collapseArtists: !this.state.collapseArtists });
  }
            ...
            return (
              <div>
                {!loading && !error && <div>
                  ...
                  <img className="image-utente" src={data.me.images[0] && data.me.images[0].url} />
                  ...
                  <div className="tracks">
                    <Button color="primary" onClick={this.toggleTracks} style={{ marginBottom: '1rem' }}>Top Tracks</Button>
                    <Collapse isOpen={this.state.collapseTracks}>
                  ...
                  <div className="artist">
                    ...
                    <Button color="primary" onClick={this.toggleArtists} style={{ marginBottom: '1rem' }}>Top Artist</Button>
                    
                    <Collapse isOpen={this.state.collapseArtists}>
                      <div className="top_artist">
                        {data.me.top_artists.map((item, idx) =>
                          <Media>
                            <Media left href="#">
                              <Media object src={item.images[2].url} />
                              <br/>
                              <br/>
